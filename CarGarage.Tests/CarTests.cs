...
namespace CarGarage.Tests
{
    public class CarTests
    {
        ...
        [Fact]
        public void SetMake_Assigns_Make_of_Car()       // name of the method                                           // Done
        {
            car.Make = "";

            // Add a SetMake method to the Car class that assigns the Make property to the value passed into the method
            // Uncomment the line below:
            car.SetMake("Honda");               // Needs a method, that is why the red is here

            Assert.Equal("Honda", car.Make);
        }

        [Fact]
        public void SetModel_Assigns_Model_of_Car()                                                                     // Done
        {
            car.Model = "";
        ...
        [Fact]
        public void GetSpeed_Should_Return_Speed()                                                                     // Done
        {
            car.Speed = 27;
        ...
        [Fact]
        public void IsSpeeding_Should_Return_True_If_Speed_Over_70mph()                                                // Done
        {
            car.Speed = 71;
        ...
        [Fact]
        public void Accelerate_Should_Increase_Speed_By_10mph()                                                         // Done
        {
            car.Speed = 0;
        ...
        [Fact]
        public void Accelerate_Should_Not_Increase_Speed_Over_100mph()                                                    // Done
        {
            car.Speed = 100;
        ...
        [Fact]
        public void Accelerate_Should_Increase_Speed_By_20mph_If_Ferrari()                                                 // Done
        {
            car.Speed = 0;
            car.Make = "Ferrari";
        ...
        [Fact]
        public void Brake_Should_Decrease_Speed_by_7mph()                                                                   // Done
        {
            car.Speed = 10;
